										...
										<c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
											<tr>
												...
												<td>
													...
													<a href="admin/remove/${admin.id }/${requestScope.pageInfo.pageNum }/${admin.loginAcct }/${param.keyword }.html" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></a>
												</td>
											</tr>
										</c:forEach>
									</c:if>
